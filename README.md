...
Current release: **v2** (`build25311513-translation-port-20260919-v2.1`)
...
**Upgrading from an older release?** Follow the upgrade steps in the [release notes](../../releases/latest).
...
- Letters, tips, item descriptions, reply choices and other on-screen text were re-wrapped to fit their boxes, and artwork that did not match the v1.10 layout was redrawn.
